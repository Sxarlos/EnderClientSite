...
The landing page for [Thendrask Launcher](https://github.com/Sxarlos/EnderClient), an open-source Minecraft launcher that browses Modrinth, CurseForge, FTB, ATLauncher, and Technic in one place.
...
- [ThendraskLauncher](https://github.com/Sxarlos/EnderClient) — the launcher itself
